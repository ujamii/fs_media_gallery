...
.. t3-field-list-table::
 ...
 - :oldFile,40:    Template file in 0.0.6
...
.. t3-field-list-table::
 ...
 - :oldProperty:     settings.album.itemsPerPage
   :newProperty:     settings.list.pagination.itemsPerPage
 ...
 - :oldProperty:     settings.image.itemsPerPage
   :newProperty:     settings.album.pagination.itemsPerPage
...
.. t3-field-list-table::
 ...
 - :oldProperty,25:    Property in 0.0.6
   :status,20:         Alteration
 ...
 - :oldProperty:    settings.image.itemsPerPage
   :status:         moved
   :newProperty:    settings.album.pagination.\
