...
========================================== ======================== ============================================================================================================== ==============
Property in 0.0.6                          Alteration               Property in 1.0.0                                                                                              Proposal
========================================== ======================== ============================================================================================================== ==============
...
.                                          new                      settings.list.thumb.\                                                                                          rename to ``scaleMode``
...
.                                          new                      settings.album.thumb.\                                                                                         rename to ``scaleMode``
...
.                                          new                      settings.album.lightbox.asset.\                                                                                rename to ``scaleMode``
...
.                                          new                      settings.detail.asset.\                                                                                        rename to ``scaleMode``
...
.                                          new                      settings.random.thumb.\                                                                                        rename to ``scaleMode``
...
settings.features.skipDefaultArguments     no change                settings.features.\                                                                                            `Extbase feature <https://forge.typo3.org/projects/typo3v4-mvc/wiki/Skip_default_arguments_in_URIs>`_ that can't be changed
